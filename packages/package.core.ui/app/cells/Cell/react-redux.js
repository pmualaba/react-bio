/**
 * Patrick Mualaba: 17/08/2018:
 * This modiefied implementation of react-redux support 2 extra arguments (nextOwnProps, ownProps) for the areStateEquals function used in Connect.
 *
    ...
    var factoryWithTypeCheckers = function(isValidElement, throwOnDirectAccess) {
        ...
        function createEnumTypeChecker(expectedValues) {
            ...
            function validate(props, propName, componentName, location, propFullName) {
                ...
                return new PropTypeError(
                    'Invalid ' + location + ' `' + propFullName + '` of value `' + propValue + '` ' + ('supplied to `' + componentName + '`, expected one of ' + valuesString + '.')
                )
            }
            return createChainableTypeChecker(validate)
        }
...
*/
        ...
        return function wrapWithConnect(WrappedComponent) {
            invariant_1$2(
                ...
                'You must pass a component to the function returned by ' + (methodName + '. Instead received ' + JSON.stringify(WrappedComponent))
            )
